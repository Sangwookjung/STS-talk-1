...
window.onload = function(){
	...
	zxcv = document.getElementById("zxcv") //var 가없으면 전역변수
	
	arr = document.getElementById("arr") 	//arr 뺴기
}
		function aaa() {
			//alert("aaa 실행")
		...
		function addDiv(ttt) {
			...
			btn_item.setAttribute("type","button") 	//타입변경
			...
			btn2_item.setAttribute("type","button") 	//타입변경
			btn2_item.setAttribute("id","btn"+no) 	//타입변경
